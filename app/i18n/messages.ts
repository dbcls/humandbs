...
const ja = {
  ...
  preview: {
    heading: "公開前の確認",
    notPublished: "NBDC ヒトデータベース事務局より、掲載予定の研究情報について、公開前のご確認をお願いいたします。",
  ...
  admin: {
    ...
    detail: {
      ...
      rows: "バージョンと下書き",
      rowsNote: [
        "下書きは「空の下書き」か、公開中のバージョンの行の「下書きの作成」で作成する。「下書きの作成」はそのバージョンの内容を複製する。",
    ...
    datasetEditor: {
      ...
      backToList: "データセットへ",
      idHeading: "データセット ID",
      idNote: "ID の割り当てと解除は、保存を待たずにその場で反映される。",
      releaseDate: "公開日",
      dateModified: "更新日",
      notYet: "未公開",
      datesArchive: "公開日と更新日は、その accession 自体の公開日と更新日を自動で表示する。",
      datesPortal: "公開日は入力する。更新日は、その accession 自体の更新日を自動で表示する。",
      files: "ファイル",
    ...
    templates: {
      ...
      taken: "研究に登録済み",
      dropped: "反映されない値",
      droppedNote: "申請と登録情報の値のうち、項目の選択肢に存在しないため反映されないもの。"
        + "作成後に手動で選択するか、解析手法の表に選択肢を追加してから再度開く。",
      openCatalog: "解析手法の表",
    ...
    publish: {
      ...
      what: "公開",
      publishNote: "公開すると、この下書きは下の番号のバージョンとして公開ページに表示され、下書きは削除される。",
      updateNote: (version: string) =>
        `更新すると、公開中の ${version} の内容がこの下書きの内容に置き換わり、下書きは削除される。番号と公開ページのアドレスは変わらない。`,
      ...
      pinTaken: "その ID は既に別のものに割り当てられています。",
      findings: "確認事項",
      findingsNote: "公開を止めないが、公開前に確かめるもの。直す場合は各画面で直し、確かめたうえで下のチェックを入れる。",
      ...
      unresolved: "未解決のコメント",
      acknowledged: "閲覧者の印",
      noAcknowledgement: "閲覧者はまだ印を押していません。",
      ...
      gone: "この下書きはもうありません。",
      publishFiles: "まとめて公開",
      privateFileNote: "データセットが選択しているファイルのうち、未公開のものをまとめて公開する。",
    },
    catalog: {
      heading: "解析手法の表",
      backToList: "解析手法の表へ",
