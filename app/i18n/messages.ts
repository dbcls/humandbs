...
const ja = {
  ...
  preview: {
    ...
    whole: "全体へのコメント",
    wholePlaceholder: "研究全体について書いてください",
  ...
  comment: {
    ...
    fieldHeading: (name: string) => `${name} のコメント`,
    add: "コメントする",
    body: "コメント",
  ...
  admin: {
    ...
    detail: {
      ...
      backToList: "研究へ",
      labels: "研究 ID",
      labelsNote: "primary ID が公開ページのアドレスになる。付け替えた古い ID を secondary に残すと、"
        + "外部からのリンクは切れない。",
      primary: "primary",
      secondary: "secondary",
      ...
      filesNote: "公開ページの「ダウンロード」に並ぶファイルの箱。研究に 1 つで、バージョンや下書きには属さない。下書きの段階から入れられ、共有リンクのプレビューには名前だけが表示される。公開・公開停止はファイルごとに行い、研究を公開しても自動では公開されない。未公開のままでも、研究を公開するときの確認画面で知らせる。",
      openFiles: "ファイル一覧",
      updating: "更新中",
      stopUpdating: "更新をやめる",
    ...
    draft: {
      ...
      state: "状態",
      order: "並び",
      notListedHeading: "載せていない",
      noListed: "まだ何も載せていません。",
      list: "載せる",
      unlist: "解除",
      moveUp: "上へ",
      moveDown: "下へ",
      ...
      deleteConfirm: "削除",
      deleteWarning: "このデータセットと、この下書きでの編集がまとめて削除されます。元に戻せません。",
      deleteRefused: "このデータセットは、この下書きが作ったまだ公開されていないものではないため削除できません。",
    ...
    datasetEditor: {
      ...
      files: "ファイル",
      filesHint: "この研究の箱にあるファイルから選ぶ。箱に無い名前は公開ページに表示されない。",
    ...
    editor: {
      memo: "メモ",
      memoHint: "この下書きについて管理者どうしで残しておく。公開ページにもプレビューにも表示されない。",
      ...
      saved: "保存しました",
      unsaved: "未保存の変更があります",
      presence: (count: number) => `他に ${count} 人`,
      presenceNobody: "他に開いている人はいません",
      presenceOthers: "他に開いている人",
      backToResearch: "研究の編集へ",
      comments: "コメント",
      differsCount: (version: number, count: number) => `v${version} と ${count} か所違います`,
      noPublishedVersion: "公開バージョンがまだないため、比較の相手がありません。",
      paneForm: "編集",
      paneFormJa: "編集 ja",
      paneFormEn: "編集 en",
      goToField: "この項目の編集",
    ...
    catalog: {
      ...
      settledNote: "この key で選べる値はポータルの仕様として決まっているため、この画面からは変えられない。",
      termsHeading: "選べる値",
      terms: "取りうる値",
      addTerm: "値の作成",
      parent: "上位",
      ...
      mergeChoosingNote: "残したい語の行で「ここへ統合」を押す。",
      mergeInto: "ここへ統合",
      mergeCancel: "やめる",
      mergeTitle: (from: string, into: string) => `${from} を ${into} に統合`,
      mergeWarning:
        "この語を指している値は、すべて統合先を指すようになります。元の語は削除されます。元に戻せません。",
      mergeConfirm: "統合",
      termsNote: "公開データセットか下書きが使っている値は削除できず、併合で畳む。",
      usage: "使用件数",
      usedSearch: (count: number) => `${count} 件を検索結果で表示`,
      unused: "0 件",
      usedCount: (count: number) => `${count} 件`,
      inUseKey: "公開中のバージョンか下書きに値があるため削除できません。",
      inUseTerm: "公開中のバージョンか下書きの値が指しているため削除できません。統合はできます。",
      find: "コードかラベルで探す",
    ...
    contents: {
      ...
      news: {
        ...
        untitled: "題目未入力",
        scheduled: "予約",
        scheduledNote: "この日時が来るまで、公開側には表示されない。",
    ...
    files: {
      ...
      find: "ファイル名で探す",
      noMatch: "その条件に当てはまるファイルはありません。",
      noBox: "研究 ID が割り当てられていないため、公開の箱がまだありません。",
      ...
      uploadHint: "アップロードしたファイルは未公開の箱に入る。公開は別の操作である。",
      uploadCancel: "中止",
...
const en: Messages = {
  ...
  preview: {
    ...
    wholePlaceholder: "Write about the research as a whole",
