...
const ja = {
  ...
  admin: {
    ...
    templates: {
      ...
      openDataset: "外部アクセッションから取り込む",
      openApplication: "提供申請から取り込む",
      choosingFor: (humLabel: string | null) =>
        `${humLabel ?? "ID 未採番の研究"} の下書きへの取り込み元を選んでいます`,
      targetCancel: "やめる",
      goIntoTarget: "この下書きに取り込む",
