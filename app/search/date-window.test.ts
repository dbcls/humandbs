...
describe("the day a date window opens on", () => {
  it("is a calendar day the query language can express, and one that exists", () => {
...
describe("the windows over a range of days", () => {
  it("offers all, and the years in the order drawn, each going where its label describes", () => {
  ...
  it("lights at most one window, and all exactly when the range restricts nothing", () => {
