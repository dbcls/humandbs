 ...
 *
 * **What the panel can read is the facet conditions directly in the top-level
 ...
 * as a chip instead: the panel would otherwise have to claim a checkbox represents
...
/** The rules of a top-level AND, or the single node on its own. */
...
export function withRange(
  ...
  // request naming one gets back the search it already was.
