...
/**
 * Which DDBJ Search resource holds the dates for an accession.
 *
 * Only the prefixes the portal's datasets actually have are listed. An
 * unrecognised one gets null and is left without a date rather than guessed
 ...
 * taken as it is — it has no time to move — and an instant is shifted
