      ...
      facets: [
        {
          ...
          kind: "disease",
          clearHref: null,
          // **More values than stand in the box**, so the catalogue shows the
          // facet that scrolls and carries a box to narrow itself.
          values: [
            {
              code: "C34",
              label: "気管支及び肺の悪性新生物＜腫瘍＞",
              maker: null,
              count: 26,
              selected: false,
            ...
            },
            {
              ...
              count: 11,
              selected: false,
              href: "/research?q=disease%3AC20",
            },
            {
              code: "C64",
              label: "腎盂を除く腎の悪性新生物＜腫瘍＞",
              maker: null,
              count: 10,
              selected: false,
              href: "/research?q=disease%3AC64",
            },
            {
              code: "C56",
              label: "卵巣の悪性新生物＜腫瘍＞",
