/**
 * The icons the portal draws, as inline SVG.
 *
...
const NODES: Record<IconName, ReactNode> = {
  ...
  */
  ...
  /*
    The same circle the other way about. Undo puts a value back; this runs the
    work again, and a reader who has learnt one of the two reads the direction
    rather than having to tell two unrelated shapes apart.
  */
  "refresh": (
    <>
  ...
  */
  ...
  /*
    The two types of a J-DS application: a sheet with a plus for a first
    registration, a sheet with a pen for an update of data already registered.
    A sheet rather than the bare plus and arrows, which are the create and redo
    controls.
  */
  "file-plus": (
    <>
 ...
 * than with a size the caller has to keep in step.
 */
