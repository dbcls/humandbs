 ...
 *
 * One place, so that the two things every response has to include cannot be
 * forgotten on one endpoint: the cross-origin header, and the content type that
 * states which of the two body formats this is.
 *
 ...
 *
 * **Bulk responses are written a record to a line.** A whole corpus in one array
