...
describe("where a draft stands on its steps", () => {
  it("counts the listing, the threads and the gate as they are", () => {
  ...
  it("counts nothing for the gate when the draft could not be read for it", () => {
    const view = stepsView({ datasetIds: [], shared: false, unresolved: 0, gate: null })
