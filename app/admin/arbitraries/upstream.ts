 ...
 * relationship between what upstream states and what a fixed vocabulary holds, so
 ...
 * checks a known word is written would never be exercised.
 */
...
// holds and `E110` is, while `Z9999` matches at no length at all.
