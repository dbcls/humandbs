 ...
 * filled in with the letters `NA`. In v2 that is the not-applicable state, which
 ...
 * words (`Illumina: NA`) states something about part of the experiment, and a
 * word such as `none` settles the question ("no deduplication was done").
 */
