...
export const Route = createLazyFileRoute("/(front)/")({
  component: Index,
})
  ...
  return (
    ...
    <section className=" flex flex-col gap-8">
      ...
      <section className=" flex h-fit justify-between gap-8">
        <article className=" ml-8 mt-8 max-w-2xl shrink">
          ...
          <div className=" mt-8 flex flex-wrap justify-center gap-4">
            <Button variant={"accent"} size={"lg"}>データを提供される方</Button>

            <Button variant={"action"} size={"lg"} onClick={() => {
      ...
      <Card className=" overflow-hidden p-0">
        <img src={Infographics} alt="Infographics" className=" w-full"></img>
      </Card>
    </section>
  )
}
