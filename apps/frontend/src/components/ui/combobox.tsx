...
function ComboboxChip({
  ...
  return (
    <ComboboxPrimitive.Chip data-slot="combobox-chip" className={className} {...props}>
      <TagPill color={color}>
        {children}
        {showRemove && (
          <ComboboxPrimitive.ChipRemove
            render={<Button variant="ghost" size={"slim"} />}
            className="-ml-1 opacity-50 hover:opacity-100"
            data-slot="combobox-chip-remove"
          >
            <XIcon className="pointer-events-none size-5" />
          </ComboboxPrimitive.ChipRemove>
        )}
      </TagPill>
