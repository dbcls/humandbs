...
export type RendererProps<K extends keyof SearchableExperimentFields = keyof SearchableExperimentFields> = {
  fieldKey: K;
...
export const searchableFieldsConfig: Partial<Record<keyof SearchableExperimentFields, FieldConfig>> = {
  // Subject / Sample
