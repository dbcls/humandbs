/**
 * API view model type definitions
 *
 * This module provides types that combine/transform ES document schemas
...
import { EsDatasetSchema, EsResearchSchema } from "./es-docs"
