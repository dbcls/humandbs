#!/bin/bash
#
# Export menu page content from Joomla DB as JSON
#
# Reads paths from output/paths-menu.txt and extracts corresponding
...
PATHS_FILE="$OUTPUT_DIR/paths-menu.txt"
OUTPUT_FILE="$OUTPUT_DIR/menu-pages-raw.json"
...
echo "Exporting ${#PATHS[@]} menu pages..."
