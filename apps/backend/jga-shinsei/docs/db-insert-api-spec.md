...
| 対象 | ファイル |
|------|----------|
| 型定義 | [`src/crawler/types/jga-shinsei.ts`](../../src/crawler/types/jga-shinsei.ts) |
| 正方向変換ロジック | [`src/crawler/processors/jga-shinsei/transform.ts`](../../src/crawler/processors/jga-shinsei/transform.ts) |
